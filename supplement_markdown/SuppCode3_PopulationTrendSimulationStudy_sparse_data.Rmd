...
subtitle: "Analysis of sparse simulated population counts with GLMMs"
...
# Predicting population change: plot entire posterior distribution
...
# Predicting population change between two time points

```{r  entire posterior distribution predict change, include=TRUE, message=FALSE, warning=TRUE}
...
legend_data2 <- data.frame(x = 2000, y = mean(sparsedat$total_pred), 
                           color = "Posterior mean distribition")
...
pop_predict.p = ggplot(data = sparsedat) + 
  ...
  scale_color_manual(name = "Data source", 
                     values = c("Simulated ('true') population size" = "red",
                              ...
                              "Posterior mean distribition" = "darkblue"))+
